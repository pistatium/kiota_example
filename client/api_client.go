...
import (
    ...
    i2a502453b9911baced1701abbdeff1a4c92523a34052019d2a56655a1a5518b7 "github.com/pistatium/kiota_example/client/posts"
)
...
func NewApiClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApiClient) {
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("file:///api/v1")
    }
    m.BaseRequestBuilder.PathParameters["baseurl"] = m.BaseRequestBuilder.RequestAdapter.GetBaseUrl()
    return m
}
// Posts the posts property
func (m *ApiClient) Posts()(*i2a502453b9911baced1701abbdeff1a4c92523a34052019d2a56655a1a5518b7.PostsRequestBuilder) {
    return i2a502453b9911baced1701abbdeff1a4c92523a34052019d2a56655a1a5518b7.NewPostsRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
